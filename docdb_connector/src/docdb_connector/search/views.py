...
from docdb_connector.database.core import get_class_by_tablename
from docdb_connector.database.service import common_parameters
from docdb_connector.database.service import composite_search
from fastapi import APIRouter, Depends
from fastapi.params import Query
from starlette.responses import JSONResponse

from docdb_connector.enums import SearchTypes, UserRoles
from docdb_connector.enums import Visibility
from .models import (
    SearchResponse,
)
